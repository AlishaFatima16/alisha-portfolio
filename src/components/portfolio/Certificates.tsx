                ...
                <ul className="divide-y divide-border/60 border-y border-border/60">
                    {certificate.map((c, i) => (
                        <Reveal key={c.t} delay={(i % 4) * 0.04}>
                            <li className="group relative grid grid-cols-12 gap-x-6 gap-y-3 py-8 md:py-10 items-center cursor-default">
                                ...
                                <span className="col-span-6 md:col-span-2 text-[10px] uppercase tracking-[0.25em] text-accent md:text-right">
                                    {c.c}
                                </span>
                                ...
                                <div className="col-span-6 md:col-span-3 flex md:justify-end">
                                    <a href={c.img} target="_blank" rel="noopener noreferrer">
                                        <img
                                            src={c.img}
                                            alt={c.t}
                                            className="h-14 w-20 md:h-16 md:w-24 object-cover rounded-lg opacity-70 group-hover:opacity-100 transition-opacity duration-500 ring-1 ring-border/60 hover:ring-accent"
                                        />
                                    </a>
                                </div>
